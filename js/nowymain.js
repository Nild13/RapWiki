window.onload = function() {
    let wynik = Math.floor(Math.random() * (2 - 1)) + 1;
    // let wynik = 1;
    console.log('Załaduj tapete i style nr: ' + wynik)
    let tlo = `'./zdjecia/wallpapers/screen${wynik}.png'`
    console.log(tlo)
    ...
    wynik == 1 ? kolorButtona.classList.toggle('searchbtn1') : wynik == 2 ? kolorButtona.classList.toggle('searchbtn4') : wynik == 3 ? kolorButtona.classList.toggle('searchbtn6') : wynik == 4 ? kolorButtona.classList.toggle('searchbtn7') : wynik == 5 ? kolorButtona.classList.toggle('searchbtn8') : wynik == 6 ? kolorButtona.classList.toggle('searchbtn6') : wynik == 7 ? kolorButtona.classList.toggle('searchbtn7') : kolorButtona.classList.toggle('searchbtn8');
  };
